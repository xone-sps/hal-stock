            ...
            <div v-if="!checkVariant" class="form-row mx-0 mb-3 bg-white rounded p-3">
                ...
                <div class="form-group col-md-4" v-if="hideCommonInput">
                    ...
                    <div class="heightError" v-if="submitted && errors.has('sallingPrice')">
                        <small class="text-danger" v-show="errors.has('sallingPrice')">
                            {{ errors.first('sallingPrice')
                            }}
                        </small>
                    </div>
                </div>
                            ...
                            <tr v-for="(item, index) in productVariant">
                                ...
                                <td class="border-0 add-product-padding">
                                    ...
                                    <div class="heightError text-nowrap">
                                        <small
                                            class="text-danger"
                                            v-show="errors.has('pReceivingPrice'+index)"
                                        >{{ errors.first('pReceivingPrice'+index) }}</small>
                                    </div>
                                </td>
                                <td class="border-0 add-product-padding">
                                    <input
                                    ...
                                    <div class="heightError text-nowrap">
                                        <small
                                            class="text-danger"
                                            v-show="errors.has('pSellingPrice'+index)"
                                        >{{ errors.first('pSellingPrice'+index) }}</small>
                                    </div>
                                </td>

                        ...
                        <div class="bg-white rounded p-3">
                                ...
                                <div id="choose_product" class="tab-pane fade"><br>
                                    <table class="table table-hover">
                                        ...
                                        <tr v-for="(barcodedata,index) in barcodeData">
                                            <td><input type="checkbox" :value='barcodedata' v-model='data'
                                                       @click='updateCheckall()'></td>
                            ...
                            <div class="row mr-0 justify-content-center">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-6 col-form-label">{{trans('lang.advance_option')}}</label>
                                        <div class="form-check">
                                            <input class="form-check-input" v-model="includeAdvanceOption"
                                                   type="radio" value="1">
                                            <label for="offline_mode_enable" class="radio-button-label">
                                                {{trans('lang.yes')}} </label>
                                            <input class="form-check-input" v-model="includeAdvanceOption"
                                    ...
                                    <div class="form-group row" v-show="includeAdvanceOption == 1">
                                        <label class="col-sm-6 col-form-label">{{trans('lang.barcode_height')}}</label>
                                        <input class="form-control col-sm-6" v-model="barcodeHeight">
                                    </div>
                                </div>

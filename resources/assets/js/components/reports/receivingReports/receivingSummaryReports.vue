        ...
        <div class="main-layout-card-header-with-button">
            <div class="main-layout-card-content-wrapper">
                <div class="main-layout-card-header-contents">
                    <h5 class="m-0">{{ trans('lang.receives_summary') }}</h5>
                </div>
            ...
            <datatable-component class="main-layout-card-content"
                                 ...
                                 :exportFileName="trans('lang.receiving_summary')"
                                 :tab_name="tabName"
    ...
    export default {
        ...
        data() {
            return {
                ...
                hidePreLoader: false,
                tableOptions: {},
                tabName : 'receiving_summary',
                routeName : 'reports',
                columnNameList: ['brand', 'category', 'group', 'product', 'supplier', 'employee', 'date'],
                hasData: value => {
                    ...
                    function (response) {
                        ...
                        if (response.data) {
                            ...
                            instance.tableOptions = {
                                ...
                                columns: [
                                    (instance.columnName !== 'supplier' && instance.columnName !== 'employee'? {title: 'lang.' + instance.columnName, key: 'filter_key',type:'text', sortable: true}
                                    :{title: 'lang.' + instance.columnName, key: 'filter_key', type: 'clickable_link', sortable: true, source: (instance.columnName == 'supplier'?'supplier':'user'),uniquefield:'id'}),
                                    {title: 'lang.item_received', key: 'item_receive', type: 'text', sortable: false},
                                    {title: 'lang.total', key: 'total', type: 'text', sortable: false},
                                ],
                                source: '/receiving-summary-report',
                                formatting : ['total'],
                                summary: true,
                                summation:['total','item_receive'],
                                summationKey:['filter_key'],
                                right_align: ['item_receive','total'],

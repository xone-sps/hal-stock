        ...
        <div class="modal-layout-content">
            ...
            <form class="form-row" v-else>
                ...
                <div class="d-table-cell align-middle text-center">
                    <h6 v-if="is_admin == 1">{{ trans('lang.be_careful_you_are_make_a_new_admin_same_as_you') }}</h6>
                    <h6 v-else>{{ trans('lang.you_are_removing_from_admin') }}</h6><br>
                </div>

                <div class="col-12">
                    <button class="btn app-color mobile-btn" type="submit" @click.prevent="enableDisableUserAdmin()">{{ buttonName() }}</button>
    ...
    export default {
        ...
        methods:{
            ...
            buttonName()
            {
                if(this.is_admin == 1)
                {
                    return this.trans('lang.mark_as_admin');
                }
                else
                {
                    return this.trans('lang.remove_from_admin');
                }
            },

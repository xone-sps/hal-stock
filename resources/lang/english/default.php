...
return array(
    ...
    */
    ...
    // corn job
    'corn_job' => 'Corn Job',
    'corn_job_link' => 'Corn job link',
    "last_corn_job_run" => "Last corn job run",
    "recommended_execution_interval" => "Recommended execution interval",
    "cpanel_corn_job_command" => "cPanel corn job command",
    ...
    "can_see_corn_job_setting" => "Can see corn job setting",
    "can_manage_corn_job_setting" => "Can manage corn job setting",
    ...
    'sales_setting_update_successfully'=> 'Sales setting Update Succcessfully',
);

...
class CashRegisterLog extends BaseModel
{
    ...
    {
        $query = CashRegisterLog::join('users', 'users.id', '=', 'cash_register_logs.opened_by')
            ->join('cash_registers', 'cash_registers.id', '=', 'cash_register_logs.cash_register_id')

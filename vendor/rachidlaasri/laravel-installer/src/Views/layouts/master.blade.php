...
<div class="master">
    <div class="box">
        ...
        <ul class="step">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{ isActive('LaravelInstaller::InstallNow')}} {{ isActive('LaravelInstaller::environmentWizard')}} {{ isActive('LaravelInstaller::environmentClassic')}}">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{ isActive('LaravelInstaller::environmentClassic')}} {{ isActive('LaravelInstaller::environmentWizard')}} {{ isActive('LaravelInstaller::environmentClassic')}}">
                @if(Request::is('install/environmentClassic') || /*Request::is('install/environment/wizard') || */ Request::is('install/environment/classic') )
            ...
            <li class="step__item {{ isActive('LaravelInstaller::user') }}">
                @if(Request::is('install/user') || /*Request::is('install/environment') || Request::is('install/environment/wizard') ||*/ Request::is('install/environment/classic') )
            ...
            <li class="step__item {{ isActive('LaravelInstaller::purchase') }}">
                @if(Request::is('install/purchase') || Request::is('install/user') )
